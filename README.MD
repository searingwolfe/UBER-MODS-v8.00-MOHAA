	*Current Version: 7.994 - Updated: 1-10-2026*

# Table of Contents

### [How To Install / Uninstall](https://github.com/searingwolfe/UBER-MODS-v8.00-MOHAA?tab=readme-ov-file#how-to-install--uninstall-1)<br>
### [Essential CVARS for UBER MODS Servers](https://github.com/searingwolfe/UBER-MODS-v8.00-MOHAA?tab=readme-ov-file#essential-cvars-for-uber-mods-servers-1)<br>
### [In-Game Menu Skin](https://github.com/searingwolfe/UBER-MODS-v8.00-MOHAA?tab=readme-ov-file#in-game-menu-skin-1)<br>
### [Elgan's Admin Pro Menu](https://github.com/searingwolfe/UBER-MODS-v8.00-MOHAA?tab=readme-ov-file#elgans-admin-pro-menu-1)<br>
### [Essential UBER BASEBUILDER Info](https://github.com/searingwolfe/UBER-MODS-v8.00-MOHAA?tab=readme-ov-file#essential-uber-basebuilder-info-1)<br>
### [UBER MODS List of CVARs](https://github.com/searingwolfe/UBER-MODS-v8.00-MOHAA?tab=readme-ov-file#uber-mods-list-of-cvars-1)<br>
### [Essential CYBER ATTACK / SEARCH & DESTROY / FREEZE TAG Info](https://github.com/searingwolfe/UBER-MODS-v8.00-MOHAA?tab=readme-ov-file#essential-cyber-attack--search--destroy--freeze-tag-info-1)<br>
### [Killstreak Rewards](https://github.com/searingwolfe/UBER-MODS-v8.00-MOHAA?tab=readme-ov-file#killstreak-rewards-1)<br>
### [Drivable Vehicles / Usable Statweapons](https://github.com/searingwolfe/UBER-MODS-v8.00-MOHAA?tab=readme-ov-file#drivable-vehicles--usable-statweapons-1)<br>
### [Singleplayer Map Mods](https://github.com/searingwolfe/UBER-MODS-v8.00-MOHAA?tab=readme-ov-file#singleplayer-maps-mods-1)<br>
### [Updates & Bug Fixes](https://github.com/searingwolfe/UBER-MODS-v8.00-MOHAA?tab=readme-ov-file#updates--bug-fixes-1)
...
| CVAR Name | Available Options | Extra Info |
| -------- | ------- | ------- |
| adddeaths | 'adddeaths 1' = add one death to $player[1]'s score. <br> <br> 'adddeaths 27' = add one death to $player[27]'s score. <br> <br> 'adddeaths Searingwolfe' = add one death to Searingwolfe's score. |   |
| addkills | 'addkills 1' = add one kill to $player[1]'s score. <br> <br> 'addkills 27' = add one kill to $player[27]'s score. <br> <br> 'addkills Searingwolfe' = add one kill to Searingwolfe's score. |   |
| admin_IPs | 'admin_IPs 1' = print list of admin IP addresses from 'level.admin_IPs', found in 'cvars/adminstuff.scr'. | This list prevents auto-changing admins' names & kicking them from stufftext detection. |
| alx_basebuild | 'alx_basebuild 0' = turn off base-building immediately & respawn everyone. | This cvar only works in Base-Builder UBER MODS gametype ('g_ubergametype' = bb). <br> <br> This cvar only works when currently base-building. |
| alx_objectlimitboost | 'alx_objectlimitboost 200' = increase base-build object limit by 200, or any # of objects. | This cvar only works in Base-Builder UBER MODS gametype ('g_ubergametype' = bb). <br> <br> This cvar only works when currently base-building. |
| alx_objectlimitdown | 'alx_objectlimitdown 200' = decrease base-build object limit by 200, or any # of objects. | This cvar only works in Base-Builder UBER MODS gametype ('g_ubergametype' = bb). <br> <br> This cvar only works when currently base-building. |
| alx_removeall | 'alx_removeall 1' = remove everything placed by $player[1]. <br> <br> 'alx_removeall 27' = remove everything placed by $player[27]. <br> <br> 'alx_removeall Searingwolfe' = remove everything placed by Searingwolfe. | This cvar only works in Base-Builder UBER MODS gametype ('g_ubergametype' = bb). |
| alx_removelifts | 'alx_removelifts 1' = remove all lifts placed by $player[1]. <br> <br> 'alx_removelifts 27' = remove all lifts placed by $player[27]. <br> <br> 'alx_removelifts Searingwolfe' = remove all lifts placed by Searingwolfe. | This cvar only works in Base-Builder UBER MODS gametype ('g_ubergametype' = bb). |
| alx_removeobjects | 'alx_removeobjects 1' = remove all static objects placed by $player[1]. <br> <br> 'alx_removeobjects 27' = remove all static objects placed by $player[27]. <br> <br> 'alx_removeobjects Searingwolfe' = remove all static objects placed by Searingwolfe. | This cvar only works in Base-Builder UBER MODS gametype ('g_ubergametype' = bb). |
| alx_removeteles | 'alx_removeteles 1' = remove all teles placed by $player[1]. <br> <br> 'alx_removeteles 27' = remove all teles placed by $player[27]. <br> <br> 'alx_removeteles Searingwolfe' = remove all teles placed by Searingwolfe. | This cvar only works in Base-Builder UBER MODS gametype ('g_ubergametype' = bb). |
| alx_removeturrets | 'alx_removeturrets 1' = remove all TurretGun objects placed by $player[1]. <br> <br> 'alx_removeturrets 27' = remove all TurretGun objects placed by $player[27]. <br> <br> 'alx_removeturrets Searingwolfe' = remove all TurretGun objects placed by Searingwolfe. | This cvar only works in Base-Builder UBER MODS gametype ('g_ubergametype' = bb). |
| alx_timeboost | 'alx_timeboost 120' = increase build time limit by 120 seconds, or any # of seconds. | This cvar only works in Base-Builder UBER MODS gametype ('g_ubergametype' = bb). <br> <br> This cvar only works when currently base-building. |
| alx_timedown | 'alx_timedown 120' = decrease build time limit by 120 seconds, or any # of seconds. | This cvar only works in Base-Builder UBER MODS gametype ('g_ubergametype' = bb). <br> <br> This cvar only works when currently base-building. |
| cg_rain_volume | 'cg_rain_volume 0.5' = set the weather's max sound volume to 0.5, or any decimal between 0 and 1. | This cvar only works if 'exec global/weather.scr' was added in the map's .scr script. |
| cg_thunder | 'cg_thunder 0' = turn on weather's thunder & lightning effects. <br> <br> 'cg_thunder 1' = turn off weather's thunder & lightning effects. | This cvar only works if 'exec global/weather.scr' was added in the map's .scr script. |
| cg_weather | 'cg_weather 0' = turn off weather precipitation. <br> <br> 'cg_weather off' = turn off weather precipitation. <br> <br> 'cg_weather snow' = begin snowing, using realistic snow values. <br> <br> 'cg_weather snow_fast' = begin snowing, using faster snow values. <br> <br> 'cg_weather blizzard' = begin blizzard, using very fast & windy snow values. <br> <br> 'cg_weather hail' = begin hailing, using snow values that quickly fall straight down. <br> <br> 'cg_weather snow_original' = begin snowing, using the game's original slow snow values. <br> <br> 'cg_weather rain' = begin raining, using realistic rain values. <br> <br> 'cg_weather drizzle' = begin drizzling, using sparse & less dense rain values. <br> <br> 'cg_weather monsoon' = begin monsooning, using very dense & windy rain values. <br> <br> 'cg_weather rain_original' = begin raining, using the game's original close-up rain values. | This cvar only works if 'exec global/weather.scr' was added in the map's .scr script. |
| cg_weather_density | 'cg_weather_density 0.1' = set the weather's precipitation density to 0.1, or any decimal between 0.06 and 5. | If some weather effects fall down in large clusters (not uniformly & steadily falling down), then the weather's density must be lowered. <br> <br> This cvar only works if 'exec global/weather.scr' was added in the map's .scr script. |
| cheats | 'cheats 0' = disable cheats. <br> <br> 'cheats 1' = enable cheats. | This cvar also changes the 'thereisnomonkey' cvar, and does not require restarting/changing the map. <br> <br> The cvars below can be used with/without cheats enabled: <br> <br> noclip2 <br> <br> nodamage <br> <br> takedamage <br> <br> wuss2 |
| check | 'check 0' = set all 'check_[trigger]' cvars to 0. | The following cvars will be set to 0: check_giantbomb, check_grenade, check_health, check_lightbomb, check_rocket, check_snowball. |
| check_giantbomb | 'check_giantbomb 0' = stop teleporting spectators to trigger's locations, delete all dummy models. <br> <br> 'check_giantbomb 1' = teleports all spectators to each of the trigger's randomized origins every 3 seconds. <br> <br> 'check_giantbomb 2' = spawn a dummy model at each of the trigger's origins. |  |
| check_grenade | 'check_grenade 0' = stop teleporting spectators to trigger's locations, delete all dummy models. <br> <br> 'check_grenade 1' = teleports all spectators to each of the trigger's randomized origins every 3 seconds. <br> <br> 'check_grenade 2' = spawn a dummy model at each of the trigger's origins. |  |
| check_health | 'check_health 0' = stop teleporting spectators to trigger's locations, delete all dummy models. <br> <br> 'check_health 1' = teleports all spectators to each of the trigger's randomized origins every 3 seconds. <br> <br> 'check_health 2' = spawn a dummy model at each of the trigger's origins. |  |
| check_lightbomb | 'check_lightbomb 0' = stop teleporting spectators to trigger's locations, delete all dummy models. <br> <br> 'check_lightbomb 1' = teleports all spectators to each of the trigger's randomized origins every 3 seconds. <br> <br> 'check_lightbomb 2' = spawn a dummy model at each of the trigger's origins. |  |
| check_rocket | 'check_rocket 0' = stop teleporting spectators to trigger's locations, delete all dummy models. <br> <br> 'check_rocket 1' = teleports all spectators to each of the trigger's randomized origins every 3 seconds. <br> <br> 'check_rocket 2' = spawn a dummy model at each of the trigger's origins. |  |
| check_snowball | 'check_snowball 0' = stop teleporting spectators to trigger's locations, delete all dummy models. <br> <br> 'check_snowball 1' = teleports all spectators to each of the trigger's randomized origins every 3 seconds. <br> <br> 'check_snowball 2' = spawn a dummy model at each of the trigger's origins. |  |
| coord2 | 'coord2 entity' = print '( 0 0 0 ) ( 0 0 0 )' coords/angles format on a new line. <br> <br> 'coord2 trigger' = print '( 0 0 0 ) ' coords format on the same line. <br> <br> 'coord2 spawn' = print '0 0 0' 'angle' '0' coords format on a new line. <br> <br> 'coord2 mapwall' = print previous '( 0 0 0 )' and current '( 0 0 0 ) 5' on the same line, and print current '( 0 0 0 )' on a new line. | This prints $player[1]'s coords & angles to a 'main/cvars/coords.txt' file. |
| coord_pointer | 'coord_pointer 1' = give/take a coord pointer to/from $player[1]. <br> <br> 'coord_pointer 27' = give/take a coord pointer to/from $player[27]. <br> <br> 'coord_pointer Searingwolfe' = give/take a coord pointer to/from Searingwolfe. | Hold USE(e) to aim the laser, and press FIRE to iprint & print to console the origin + angle of the aimed target (also writes to 'cvars/coords.txt'). <br> <br> Hold USE(e) + Lean Left/Right + press FIRE to teleport to the aimed target location (iprints coords, but does not write to 'cvars/coords.txt'). |
| cybsnd_debug | 'cybsnd_debug 0' = stop printing. <br> <br> 'cybsnd_debug 1' = print once per second the Allies/Axis team count (living players) and Allies/Axis team total. | This cvar only works if 'g_ubergametype' = cyb, snd, ft. |
| cybsnd_info | 'cybsnd_info 1' = print once the round start time, rounds to win, change sides (0 or 1 for switching bombsites), melt time, melt respawn (0 or 1 for spawning at frozen body or regular spawn), spectators auto-join teams (once round begins), bomb camera (1 or 0, when bomb explodes), bomb camera distance. | This cvar only works if 'g_ubergametype' = cyb, snd, ft. |
| cybsnd_score | 'cybsnd_score 1' = print once the current Cyber Attack, Search & Destroy, or Freeze Tag score (rounds Allies won, Axis won). | This cvar only works if 'g_ubergametype' = cyb, snd, ft. |
| drawpath | 'drawpath 0' = delete all nodes & lasers drawn by the drawpath cvar. <br> <br> 'drawpath bomberpath' = draw a .target node path, starting with $bomberpath (or any other targetname, not including the dollar sign). <br> <br> 'drawpath spotpath1_1' = draw a .target node path, starting with $spotpath1_1. <br> <br> 'drawpath latertruckpath' = draw a .target node path, starting with $latertruckpath. <br> <br> 'drawpath exploderchunk[1]' = draw a .target node path, starting with $exploderchunk[1] (or any other [index] value if 2+ entities share a targetname). <br> <br> 'drawpath exploderchunk[12]' = draw a .target node path, starting with $exploderchunk[12]. | This spawns visible nodes & lasers, and connects them to each node's .target, until there's no more .targets or until the .target reaches an already-drawn node (looped path). <br> <br> The path starts at the specified targetname, then travels to its .target = the target node's targetname, then travels to that .target's .target, and so on. <br> <br> For example: $node1.target = node2; $node2.target = node3; $node3.target = node4. To make a loop: $node4.target = node1. |
| drawsize | 'drawsize 0' = delete all lasers drawn by the drawsize cvar. <br> <br> 'drawsize trigger_explode' = draw lasers around the edges of $trigger_explode (or any other targetname, not including the dollar sign). <br> <br> 'drawsize tank01' = draw lasers around the edges of $tank01. <br> <br> 'drawsize exploder_trigshot' = draw lasers around the edges of $exploder_trigshot. <br> <br> 'drawsize exploder_trigger[1]' = draw lasers around the edges of $exploder_trigger[1] (or any other [index] value if 2+ entities share a targetname). <br> <br> 'drawsize exploder_trigger[12]' = draw lasers around the edges of $exploder_trigger[12]. | This spawns lasers around the +/- setsize edges of a trigger/entity, outlining its min/max dimensions in 3D. <br> <br> Green lasers = positive-most setsize2's vertex. Red lasers = negative-most setsize1's vertex. <br> <br> To use this cvar: setsizes must be saved to '.setsize1' and '.setsize2'. Example $trigger with setsizes below: <br> <br> $trigger setsize ( -100 -100 -10 ) ( 100 100 50 ) <br> <br> $trigger.setsize1 = ( -100 -100 -10 ) <br> <br> $trigger.setsize2 = ( 100 100 50 ) |
| entities | 'entities 1' = wait 4 seconds to print # of entities & remaining entities until maxentities (1024) is reached. <br> <br> 'entities 2' = print all entities & their targetnames (or NULL) from 1 to maxentities. <br> <br> 'entities 3' = print all entities & their targetnames, but print slower. <br> <br> 'entities 4' = print only non-NULL entities ($player entities do not print for 'entities 4, 5, 6, 7'). <br> <br> 'entities 5' = print only non-NULL entities that have targetnames. <br> <br> 'entities 6' = print only non-NULL entities that do not have targetnames (targetnames = ''). <br> <br> 'entities 7' = print only non-NULL entities, and print their classnames. <br> <br> 'entities 8' = print only non-NULL entities, and print only if they have a '.target' entity specified. | Simple entities such as Actor path nodes, spawn points, and waypoints are NULL/don't exist in the game and won't be counted. Spline nodes, however, do exist. <br> <br> This cvar can only count up to 869 entities, even though the game's max entity count is 1024. |
| entity_pointer | 'entity_pointer 1' = give/take an entity pointer to/from $player[1]. <br> <br> 'entity_pointer 27' = give/take an entity pointer to/from $player[27]. <br> <br> 'entity_pointer Searingwolfe' = give/take an entity pointer to/from Searingwolfe. | Hold USE(e) to aim the laser at a solid entity, and press FIRE to iprint & print to console the entity's info: origin, angles, classname, model, targetname, entnum, etc. <br> <br> Hold USE(e) + Lean Left/Right + press FIRE to teleport to the aimed target location. |
| faceto | 'faceto truckclip' = make all players look at $truckclip (or any other targetname, not including the dollar sign). <br> <br> 'faceto endtrigger' = make all players look at $endtrigger. <br> <br> 'faceto aispawn' = make all players look at $aispawn. <br> <br> 'faceto barrel[1]' = make all players look at $barrel[1] (or any other [index] value if 2+ entities share a targetname). <br> <br> 'faceto barrel[12]' = make all players look at $barrel[12]. | This makes all players on the map face towards/look at the entity (also printing: origin, angles, model, entnum, target, etc). |
| file_playernames | 'file_playernames' = print list of saved player names & IPs that were present at the end of the previous map. | This list is refreshed after each map change/restart, and is found at 'cvars/playernames.txt'. <br> <br> This list prevents players that are trying to copy another player's name from getting priority if they joined the next map first. |
| find | 'find truckclip' = teleport all players to $truckclip (or any other targetname, not including the dollar sign). <br> <br> 'find endtrigger' = teleport all players to $endtrigger. <br> <br> 'find aispawn' = teleport all players to $aispawn. <br> <br> 'find barrel[1]' = teleport all players to $barrel[1] (or any other [index] value if 2+ entities share a targetname). <br> <br> 'find barrel[12]' = teleport all players to $barrel[12]. | This teleports all players on the map to the $entity's coordinates (also printing: origin, angles, model, entnum, target, etc). <br> <br> This also works for finding simple entities that are NULL/don't exist as real entities, such as Actor path nodes, spawn points, and waypoints. |
| findclass | 'findclass ScriptModel' = print all ScriptModel entities (or any other classname). <br> <br> 'findclass CrateObject' = print all CrateObject entities. <br> <br> 'findclass TurretGun' = print all TurretGun entities. <br> <br> 'findclass Trigger' = print all Trigger entities. | This finds all entities on the map with the specified classname, and prints their entnums & targetnames. <br> <br> This cvar can only count up to 869 entities, even though the game's max entity count is 1024. <br> <br> Classnames are case-sensitive. <br> <br> Some classnames are subcategories of other classnames. <br> <br> For example, Trigger may also include TriggerUse entities, and ScriptModel may also include ScriptSlave entities. |
| findent | 'findent 65' = teleport all players to the entity with entnum = 65. <br> <br> 'findent 450' = teleport all players to the entity with entnum = 450. | This teleports all players on the map to the entnum's coordinates (also printing: origin, angles, model, entnum, target, etc). <br> <br> This cvar only works for entnum integers up to 868, even though the game's max entity count is 1024. <br> <br> This cvar does not work for integers < the 'sv_maxclients' cvar. <br> <br> In other words, it cannot be used to find players, since player slots fill up: entnum 0 to entnum (sv_maxclients - 1). |
| findmodel | 'findmodel models/static/indycrate.tik' = print all entities that have indycrate.tik models (or any other model path). <br> <br> 'findmodel models/static/indycrate' = print all entities that have indycrate.tik models. <br> <br> 'findmodel static/indycrate.tik' = print all entities that have indycrate.tik models. <br> <br> 'findmodel static/indycrate' = print all entities that have indycrate.tik models. | This finds all entities on the map with the specified model path, and prints their entnums & targetnames. <br> <br> This cvar can only count up to 869 entities, even though the game's max entity count is 1024. <br> <br> Model paths are case-sensitive. <br> <br> For simplicity, this cvar still works without including the 'models/' and '.tik' portions of the model path. |
| findset | 'findset 7' = print all entities with #set 7 (or any other integer set number). <br> <br> 'findset 20' = print all entities with #set 20. <br> <br> 'findset all' = print all entities that are part of a #set. <br> <br> 'findset exploder' = print all $exploder entities. <br> <br> 'findset exploders' = print all $exploder entities. <br> <br> 'findset exploderfire' = print all $exploderfire entities. <br> <br> 'findset exploderfires' = print all $exploderfire entities. | If an integer, this finds all entities whose #set matches the integer (for example: $entity.set = 7), and prints their entnums & targetnames. <br> <br> If 'all', this finds all entities that have a #set value, prints their entnums and #set values, and prints the total number of entities for each #set. <br> <br> If 'exploder', this prints all $exploder entities' origin and #set, and prints the total number of $exploder entities for each #set (or 0, if none). <br> <br> If 'exploderfire', this prints all $exploderfire data saved within the 'level.exploderfire' matrix array. <br> <br> The 'level.exploderfire' array is created by 'global/exploder.scr', which removes all $exploderfire entities afterwards. <br> <br> The 'level.exploderfire' array has one row for each $exploderfire, and has columns: model, origin, angles, scale, set #, pause, damage, damageradius, fire. <br> <br> This cvar can only count up to 869 entities, even though the game's max entity count is 1024. |
| g_deathcam | 'g_deathcam 0' = disable deathcams; players will stay at their dead bodies as normal. <br> <br> 'g_deathcam 1' = enable deathcams; players will spectate their killers for a few seconds. | The Deathcams mod cannot be used in Freeze Tag, Cyber Attack, or Search & Destroy UBER MODS gametypes. |
| g_ubergametype | 'g_ubergametype bb' = set UBER MODS gametype to Base-Builder. <br> <br> 'g_ubergametype cyb' = set UBER MODS gametype to Cyber Attack. <br> <br> 'g_ubergametype snd' = set UBER MODS gametype to Search & Destroy. <br> <br> 'g_ubergametype ft' = set UBER MODS gametype to Freeze Tag. <br> <br> 'g_ubergametype 0' = set UBER MODS gametype to none, or regular TDM or FFA (based on 'g_gametype' cvar). | This cvar will take effect when the map changes/restarts. |
| g_uberhardcode | 'g_uberhardcode 0' = re-enable the 'g_ubergametype' cvar. <br> <br> 'g_uberhardcode 1' = force all maps to use the g_ubergametypes list found in 'global/uberversion.scr'. | If enabled, this cvar will disable the 'g_ubergametype' cvar, which is set for all maps. <br> <br> If enabled, this cvar allows different g_ubergametypes for each map to occur in one map rotation. <br> <br> Change the hard-coded list for each map in 'global/uberversion.scr' as needed. <br> <br> This cvar will take effect when the map changes/restarts. |
| g_ubermods | 'g_ubermods 0' = all UBER mods disabled for each map. <br> <br> 'g_ubermods 1' = for SP maps: no crates or teles, a few UBER triggers; for MP maps: crates & teles, some extra UBER mods. <br> <br> 'g_ubermods 2' = default; all UBER mods enabled. | This cvar will take effect when the map changes/restarts. |
| g_throwingknives | 'g_throwingknives 0' = turn off the throwing knives mod. <br> <br> 'g_throwingknives 1' = all players spawn with 1 throwing knife (hold USE[e] + FIRE[zoom] to throw), and extra knives spawn around the map. | This cvar will take effect when the map changes/restarts. |
| hacker_kill | 'hacker_kill 0' = turn off this cvar. <br> <br> 'hacker_kill 1' = continuously kill $player[1]. <br> <br> 'hacker_kill 27' = continuously kill $player[27]. <br> <br> 'hacker_kill Searingwolfe' = continuously kill the player named 'Searingwolfe'. | Only one player at a time can be affected by this cvar. |
| hacker_takeall | 'hacker_takeall 0' = turn off this cvar. <br> <br> 'hacker_takeall 1' = continuously take all of $player[1]'s weapons. <br> <br> 'hacker_takeall 27' = continuously take all of $player[27]'s weapons. <br> <br> 'hacker_takeall Searingwolfe' = continuously take all of Searingwolfe's weapons. | Only one player at a time can be affected by this cvar. |
| help | 'help 0' = print all available UBER MODS cvars. <br> <br> 'help 1' = print all available UBER MODS cvars. <br> <br> 'help all' = print all available UBER MODS cvars. <br> <br> 'help [UBER cvar name]' = print all available options & info for that cvar. |  |
| hide | 'hide 1' = make $player[1] invisible. <br> <br> 'hide 27' = make $player[27] invisible. <br> <br> 'hide Searingwolfe' = make Searingwolfe invisible. |  |
| noclip2 | 'noclip2 1' = turn on/off noclip mode for $player[1]. <br> <br> 'noclip2 27' = turn on/off noclip mode for $player[27]. <br> <br> 'noclip2 Searingwolfe' = turn on/off noclip mode for Searingwolfe. | This cvar will still work if cheats are disabled. |
| nodamage | 'nodamage 1' = prevent $player[1] from taking damage. <br> <br> 'nodamage 27' = prevent $player[27] from taking damage. <br> <br> 'nodamage Searingwolfe' = prevent Searingwolfe from taking damage. |  |
| spectator | 'spectator 0' = turn off this cvar. <br> <br> 'spectator 1' = continuously force $player[1] into spectator. <br> <br> 'spectator 27' = continuously force $player[27] into spectator. <br> <br> 'spectator Searingwolfe' = continuously force Searingwolfe into spectator. | Only one player at a time can be affected by this cvar. |
| players | 'players 1' = print the # of players in-game (applies to all 'players' cvar cases). <br> <br> 'players 2' = print each player's clientnum, $player[index], netname, and IP address. <br> <br> 'players 3' = print all player/client slots (based on 'sv_maxclients') even if they're NULL. |  |
| playerspawns | 'playerspawns 0' = remove all dummy models at player spawn points. <br> <br> 'playerspawns 1' = spawn dummy models at all 'info_player_[allied, axis, deathmatch]' spawn points, only if their targetnames = 'allied_spawn', 'axis_spawn', 'deathmatch_spawn'. |  |
| proximity_pointer | 'proximity_pointer 1' = give/take a proximity pointer to/from $player[1]. <br> <br> 'proximity_pointer 27' = give/take a proximity pointer to/from $player[27]. <br> <br> 'proximity_pointer Searingwolfe' = give/take a proximity pointer to/from Searingwolfe. | Hold USE(e) to aim the laser near a notsolid entity or trigger (ideally near their origins), and press FIRE to iprint & print to console the entity's info. <br> <br> Press FIRE without holding USE(e) to iprint & print to console the entity's info that is closest to the player (not including weapons or attached throwing knives). <br> <br> Hold USE(e) + Lean Left/Right + press FIRE to teleport to the aimed target location. |
| score | 'score 1' = print once each player's kills and deaths, along with their $player[client num] and netname. |  |
| show | 'show 1' = make $player[1] visible. <br> <br> 'show 27' = make $player[27] visible. <br> <br> 'show Searingwolfe' = make Searingwolfe visible. |  |
| subtractdeaths | 'subtractdeaths 1' = subtract one death from $player[1]'s score. <br> <br> 'subtractdeaths 27' = subtract one death from $player[27]'s score. <br> <br> 'subtractdeaths Searingwolfe' = subtract one death from Searingwolfe's score. |  |
| subtractkills | 'subtractkills 1' = subtract one kill from $player[1]'s score. <br> <br> 'subtractkills 27' = subtract one kill from $player[27]'s score. <br> <br> 'subtractkills Searingwolfe' = subtract one kill from Searingwolfe's score. |  |
| takedamage | 'takedamage 1' = allow $player[1] to take damage. <br> <br> 'takedamage 27' = allow $player[27] to take damage. <br> <br> 'takedamage Searingwolfe' = allow Searingwolfe to take damage. |  |
| teams | 'teams 1' = print once each player's current team (allies, axis, spectator, or free-for-all if 'g_gametype' = 1) and their $player[client num] and netname, and print the total number of players on each team. |  |
| time | 'time 1' = print once the map's time remaining (in minutes:seconds format). |  |
| timelimit | 'timelimit 0' = turn off 'time remaining', and prevent the server from auto-changing maps. <br> <br> 'timelimit 0.5' = set the map's time to 1 minute remaining. <br> <br> 'timelimit 1' = set the map's time to 1 minute remaining. <br> <br> 'timelimit 5' = set the map's time to 5 minutes remaining. <br> <br> 'timelimit 20' = set the map's time to 20 minutes remaining. | The map's current time played is subtracted from the timelimit cvar. <br> <br> For example, if the map started at 20 minutes (timelimit 20) and 5 minutes have passed, and if the timelimit is set to 15, then the map's 'time remaining' will be 10 minutes instead of 15 minutes. <br> <br> If map has been playing for less than 1 minute (i.e. > 19 miutes remaining), and if timelimit it set to 0.5, then the victory podium script will play until the full minute has passed. <br> <br> Otherwise, setting timelimit to 0.5 after the map's first 1 minute has passed will begin intermission immediately. <br> <br> The console will print 'Intermission is starting shortly...' if the server is beginning to change maps. |
| track | 'track 0' = turn off tracking. <br> <br> 'track 1' = iprint each player's coords & angle to their own screens once every 3 seconds. <br> <br> 'track 2' = also print each player's coords & angle to the server's console window. | This cvar will continue printing if the server changes maps, and must be turned off manually. |
| votekick | 'votekick 1' = begin a vote to kick & ban $player[1] from the server. <br> <br> 'votekick 27' = begin a vote to kick & ban $player[27] from the server. <br> <br> 'votekick Searingwolfe' = begin a vote to kick & ban Searingwolfe from the server. | All players' default voting choice is set to NO. <br> <br> All players can vote to kick the specified player using the following keyboard controls: <br> <br> Hold USE(e) key + Lean Left = VOTE NO. <br> <br> Hold USE(e) key + Lean Right = VOTE YES. |
| wuss2 | 'wuss2 1' = give $player[1] all weapons. <br> <br> 'wuss2 27' = give $player[27] all weapons. <br> <br> 'wuss2 Searingwolfe' = give Searingwolfe all weapons. | This cvar will still work if cheats are disabled. |
...
- For "g_ubermods 2":
	...
	- The red-pulsating transformer in the Axis spawn garage building can be blown up with grenades/rockets/etc, blowing up the 2 outdoor electrical generators, spawning electric_arc emitters, and flashing white (resets after 60 seconds).
- For "g_ubermods 1":
...
Drivable vehicles & flak88 turrets improved.
	...
	- Fixed passengers being unable to damage other enemies by shooting at them while seated.
